...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 12-11-2022 a las 00:04:00
...
--
-- Base de datos: `tests_implantacion`
--
...
CREATE TABLE `users` (
  ...
  `s_apellIido` varchar(150) NOT NULL,
...
--
ALTER TABLE `users_roles`
  MODIFY `users_roles_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `cabezera_empresa`
  ADD CONSTRAINT `ce_factura_id_fk` FOREIGN KEY (`factura_id`) REFERENCES `factura` (`factura_id`) ON DELETE NO ACTION ON UPDATE CASCADE;
...
--
ALTER TABLE `factura`
  ADD CONSTRAINT `ffk_user_id` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`) ON DELETE NO ACTION ON UPDATE CASCADE;

--
-- Filtros para la tabla `historial`
--
ALTER TABLE `historial`
  ADD CONSTRAINT `h_factura_id_fk` FOREIGN KEY (`factura_id`) REFERENCES `factura` (`factura_id`) ON DELETE NO ACTION ON UPDATE CASCADE,
  ADD CONSTRAINT `h_user_id_fk` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`) ON DELETE NO ACTION ON UPDATE CASCADE;

--
-- Filtros para la tabla `inventario`
--
ALTER TABLE `inventario`
  ADD CONSTRAINT `inventario_ibfk_1` FOREIGN KEY (`product_id`) REFERENCES `product` (`product_id`);
...
--
ALTER TABLE `pedidos_users`
  ADD CONSTRAINT `pu_pedido_id_fk` FOREIGN KEY (`pedido_id`) REFERENCES `pedidos` (`pedido_id`) ON DELETE NO ACTION ON UPDATE CASCADE,
  ADD CONSTRAINT `pu_user_id_fk` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`) ON DELETE NO ACTION ON UPDATE CASCADE;

--
-- Filtros para la tabla `product_categories`
--
ALTER TABLE `product_categories`
  ADD CONSTRAINT `category_id` FOREIGN KEY (`category_id`) REFERENCES `categories` (`category_id`) ON DELETE NO ACTION ON UPDATE CASCADE,
  ADD CONSTRAINT `users_pc_fk` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`);

--
-- Filtros para la tabla `shopping_cart`
--
ALTER TABLE `shopping_cart`
  ADD CONSTRAINT `product_id` FOREIGN KEY (`product_id`) REFERENCES `product` (`product_id`) ON DELETE NO ACTION ON UPDATE CASCADE,
...
--
ALTER TABLE `users`
  ADD CONSTRAINT `users_ibfk_1` FOREIGN KEY (`direccion_id`) REFERENCES `direcciones` (`direccion_ID`);

--
-- Filtros para la tabla `users_roles`
--
ALTER TABLE `users_roles`
  ADD CONSTRAINT `rol_id` FOREIGN KEY (`rol_id`) REFERENCES `roles` (`rol_id`) ON DELETE NO ACTION ON UPDATE CASCADE,
